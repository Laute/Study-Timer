...
function HorizontalRadioButton() {
        ...
        return (
          <form onSubmit={handleSubmit}>
            <div>
              <label>
                <input type="radio" value="day" checked={studyPeriods == 'Day'} change={handleChange} />
                <span>Day</span>
              </label>
              <label>
                <input type="radio" value="week" checked={studyPeriods == 'Week'} change={handleChange} />
                <span>Week</span>
              </label>
              <label>
                <input type="radio" value="month" checked={studyPeriods == 'Month'} change={handleChange} />
                <span>Month</span>
              </label>
              <label>
                <input type="radio" value="year" checked={studyPeriods == 'Year'} change={handleChange} />
                <span>Year</span>
              </label>
            </div>
